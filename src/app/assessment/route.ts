...
export async function GET() {
  try {
    ...
    const html = (
      ...
      "</head>",
      '<link rel="stylesheet" href="/unified-font.css"><link rel="stylesheet" href="/permissions-scroll.css?v=20260922-native-scroll"><link rel="stylesheet" href="/system-topbar.css"><script defer src="/system-topbar.js"></script></head>',
    );
